...
@property (nonatomic) IBOutlet UIDatePicker * __null_unspecified datePickerView;
@property (nonatomic) IBOutlet UITextField * __null_unspecified startTimeTextField;
@property (nonatomic) IBOutlet UIDatePicker * __null_unspecified timePickerView;
@property (nonatomic) IBOutlet UITextField * __null_unspecified durationTextField;
@property (nonatomic) IBOutlet UIDatePicker * __null_unspecified durationPickerView;
...
- (void)handleTimePicker:(UIDatePicker * __nonnull)sender;
